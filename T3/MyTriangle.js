...
MyTriangle.prototype.constructor=MyTriangle.angle;
...
MyTriangle.prototype.setTexScale = function (tex_scale_factor){
	this.texCoords = [
		(this.distC - this.distA*Math.cos(this.angB)) / tex_scale_factor[0] , this.distA*Math.sin(this.angB) / tex_scale_factor[1],
	     0, 0,
		 this.distC / tex_scale_factor[0], 0];
